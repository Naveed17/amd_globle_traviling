...
public function updatePayment(Request $request)
{
    ...
    try {
        ...
        foreach ($settings as $key => $value) {
            ...
            if (in_array($key, ['stripe_test_mode', 'paypal_sandbox_mode', 'razorpay_test_mode', 'square_sandbox_mode', 'stripe_enabled', 'paypal_enabled', 'razorpay_enabled', 'square_enabled'])) {
                $value = $value === '1' ? '1' : '0';
            }
