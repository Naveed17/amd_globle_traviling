            ...
            <div style="max-width: 700px; margin: 0 auto; background: white; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1);">
                ...
                <div style="padding: 40px 30px;">
                    ...
                    <p style="font-size: 16px; color: #555; line-height: 1.7; margin: 0 0 25px 0;">
                        Thank you for reaching out to AMD Global. We have received your message and our team will review it shortly. We appreciate you taking the time to contact us!
                    </p>
                    ...
                    <div style="background: #f8f9fa; border-left: 4px solid #667eea; padding: 20px; border-radius: 0 8px 8px 0; margin-bottom: 20px;">
                        ...
                        <p style="margin: 0; color: #6c757d; font-size: 14px; line-height: 1.7;">
                            ...
                            <strong>Email:</strong> <a href="mailto:team@amdglobal.de" style="color: #667eea; text-decoration: none;">team@amdglobal.de</a><br>
                ...
                <div style="background: #343a40; color: white; padding: 25px 30px; text-align: center;">
                    ...
                    <div style="margin: 20px 0 15px 0;">
                        <a href="#" style="display: inline-block; width: 35px; height: 35px; background: rgba(255,255,255,0.1); border-radius: 50%; margin: 0 5px; line-height: 35px; text-decoration: none; color: white;">f</a>
                        <a href="#" style="display: inline-block; width: 35px; height: 35px; background: rgba(255,255,255,0.1); border-radius: 50%; margin: 0 5px; line-height: 35px; text-decoration: none; color: white;">t</a>
                        <a href="#" style="display: inline-block; width: 35px; height: 35px; background: rgba(255,255,255,0.1); border-radius: 50%; margin: 0 5px; line-height: 35px; text-decoration: none; color: white;">in</a>
                        <a href="#" style="display: inline-block; width: 35px; height: 35px; background: rgba(255,255,255,0.1); border-radius: 50%; margin: 0 5px; line-height: 35px; text-decoration: none; color: white;">ig</a>
                    </div>
