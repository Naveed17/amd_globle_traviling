            ...
            <div class="payment-method-card">
                <div class="payment-header">
                    <div class="payment-info">
                        <div class="payment-logo logo-stripe">
        ...
        <span class="status-slider"></span>
                ...
                <div class="config-form" id="stripeConfig" style="display: none;">
                    <div class="config-header">
                        <div class="config-title">
                            <div class="payment-logo logo-stripe" style="width: 40px; height: 40px; font-size: 1rem;">
                                <i class="bi bi-credit-card"></i>
                            </div>
            ...
            <div class="payment-method-card">
                ...
                <div class="config-form" id="paypalConfig" style="display: none;">
                    <div class="config-header">
                        <div class="config-title">
                            <div class="payment-logo logo-paypal" style="width: 40px; height: 40px; font-size: 1rem;">
                                PP
                            </div>
...
function saveAllPaymentSettings() {
    const forms = ['stripeForm', 'paypalForm', 'razorpayForm', 'squareForm', 'generalForm'];
    let savedForms = 0;
    let hasErrors = false;
