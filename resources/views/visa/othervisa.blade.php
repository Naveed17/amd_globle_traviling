...
/* end visa form */
        ...
        <div class="form-container">
            ...
            <div class="text-center mb-4">
                <h2>OTHER VISA REQUEST FORM</h2>
                <p class="text-muted">Please fill out all required fields marked with *</p>
            </div>
            
            <form id="visaRequestForm" class="needs-validation" novalidate method="POST" action="{{ route('visa.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <select class="form-select" id="nationality" name="nationality" required>
                            ...
                            <!-- For brevity, I'm showing just a few options -->
                            <!-- In production, you would include all countries -->
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        <label for="passportFront" class="form-label required-field">Passport Front Image</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="passportBack" class="form-label required-field">Passport Back Image</label>
                        <div class="custom-file-upload">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-upload upload-icon"></i></span>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        <label for="passportSize" class="form-label required-field">Passport Size Image</label>
                        <div class="custom-file-upload">
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-upload upload-icon"></i></span>
                ...
                <div class="agreement-box">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="agreeTerms" name="agreed_terms" required>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('visaRequestForm');
...
function showSuccessMessage() {
    const successHtml = `
        <div style="text-align: center; padding: 50px; background: white; border-radius: 20px; box-shadow: 0px 10px 50px 0 rgba(0, 0, 0, 0.1);">
            ...
            <h2 style="color: #28a745; margin-bottom: 20px; font-size: 32px; font-weight: 700;">Visa Application Submitted!</h2>
            <p style="font-size: 18px; margin-bottom: 30px; color: #666;">
                Thank you! Your visa application has been submitted successfully.<br>
            ...
            <div style="background: linear-gradient(135deg, #e8f5e8, #d4edda); padding: 20px; border-radius: 15px; margin: 20px 0;">
                <div style="display: flex; justify-content: space-around; text-align: center;">
                    <div>
                        ...
                        <div style="font-size: 14px; color: #666;">3-5 Business Days</div>
                    </div>
                    <div>
