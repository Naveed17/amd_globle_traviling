...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('travel-partners')->name('admin.travel-partners.')->group(function () {
        ...
        Route::delete('/{partner}', [TravelPartnerController::class, 'destroy'])->name('destroy');

        // Corrected additional custom routes
        Route::patch('/{partner}/activate', [TravelPartnerController::class, 'activate'])
            ->name('activate');
            
        Route::patch('/{partner}/suspend', [TravelPartnerController::class, 'suspend'])
            ->name('suspend');
    });
